...
VALUES
    ...
    (106, 'Mohinder Laine', 'mohinder.laine@email.com','test','Admin'),
    (107, 'Bran Sulzbach', 'bran.sulzbach@email.com','test','Admin'),
    (108, 'Slavko Doherty', 'slavko.doherty@email.com','test','Regular User'),
    (109, 'Sally Sebastiani', 'sally.sebastiani@email.com','test','Regular User'),
    (110, 'Layla Caiazzo', 'layla.caiazzo@email.com','test','Regular User'),
    (111, 'Augusts Nyman', 'augusts.nyman@email.com','test','Admin'),
    (112, 'Ara Palomer', 'ara.palomer@email.com','test','Regular User'),
    (113, 'Oskar Boyadjiev', 'oskar.boyadjiev@email.com','test','Regular User'),
    (114, 'Madhuri Joshi', 'madhuri.joshi@email.com','test','Regular User'),
    (115, 'Devi Kaur', 'devi.kaur@email.com','test','Regular User');
...
VALUES
    ...
    (314, 'US1987654321', '3987654313', 'VKG Ltd', '2027-02-23', 2.55, 'Stock', 700, 'Active'),
